...
export default function SvgArrowRight({ className, onClick }) {
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28" className={className} onClick={onClick}>
